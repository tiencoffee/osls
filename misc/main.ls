App = m.component do
	oninit: (v) !->
		...
		@items =
			...
			* text: "Chia sẻ"
				...
				submenu:
					* text: "Facebook"
						icon: \//www.flaticon.com/svg/static/icons/svg/733/733547.svg
						submenu:
							* text: "Facebook"
								icon: \//www.flaticon.com/svg/static/icons/svg/733/733547.svg
							* text: "Messenger"
								icon: \//www.flaticon.com/svg/static/icons/svg/733/733548.svg
					* text: "Twitter"
						icon: \//www.flaticon.com/svg/static/icons/svg/733/733579.svg
						color: \blue
					* text: "LINE"
						icon: \//www.flaticon.com/svg/static/icons/svg/2111/2111498.svg
						color: \green
					* text: "Pinterest"
						icon: \//www.flaticon.com/svg/static/icons/svg/220/220214.svg
						color: \red
					* text: "Tiktok"
						icon: \//www.flaticon.com/svg/static/icons/svg/3046/3046121.svg
			* text: "Tìm kiếm trên Google..."
				icon: \//image.flaticon.com/icons/svg/2702/2702602.svg
		@selectItems =
			* text: "Rết"
				value: \ret
		...
		@table =
			* text: "Samurott"
				icon: \//www.serebii.net/pokedex-swsh/icon/503.png
				type: "Water"
			* text: "Beedrill (Mega)"
				icon: \//www.serebii.net/pokedex-swsh/icon/015-m.png
				type: "Bug / Poison"
			* text: "Stonjourner"
				icon: \//www.serebii.net/pokedex-swsh/icon/874.png
				type: "Rock"
			* text: "Darmanitan (Galarian Form Zen Mode)"
				icon: \//www.serebii.net/pokedex-swsh/icon/555-gz.png
				type: "Ice / Fire"
			* text: "Exeggutor (Galarian Form)"
				icon: \//www.serebii.net/pokedex-swsh/icon/103-a.png
				type: "Grass / Dragon"
			* text: "Gyarados"
				icon: \//www.serebii.net/pokedex-swsh/icon/130.png
				type: "Water / Flying"
			* text: "Sawsbuck (Autumn Form)"
				icon: \//www.serebii.net/pokedex-swsh/icon/586-a.png
				type: "Normal / Grass"
			* text: "Shellos (East Sea)"
				icon: \//www.serebii.net/pokedex-swsh/icon/422-e.png
				type: "Water"
			* text: "Kyurem"
				icon: \//www.serebii.net/pokedex-swsh/icon/646.png
				type: "Dragon / Ice"
		@selectVal = "rai ca"
	...
	view: ->
		m \.p-3.full.scroll-y,
			...
			m ControlGroup,
				...
				if @isShowPopover
					m Popover,
						...
						content: (popover) ~>
							m \.p-3,
								m \h3 "Thời gian Unix h.tại là:"
								m \p.text-small Date.now!
								m ControlGroup,
									m Button,
										\OK
									m Button,
			...
			m Icon, name: \//www.flaticon.com/svg/static/icons/svg/891/891257.svg
			m Button,
				onclick: !~>
					@val = ""
				"Reset val"
